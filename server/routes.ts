...
⚡ ДОСТУПНІ ТАЙМФРЕЙМИ: 1, 3, 5, 10, 15, 30 хвилин, 60, 120, 180, 240 хвилин (1-4 години)
- UP = ціна буде ВИЩЕ поточної через X хвилин/годин
- DOWN = ціна буде НИЖЧЕ поточної через X хвилин/годин

🎯 ЯК ОБРАТИ ТАЙМФРЕЙМ:

📍 1-3 ХВИЛИНИ (скальпінг):
• RSI > 75 або < 25 = екстремальний сигнал, швидкий відскок
• BB > 90% або < 10% = ціна на екстремумі
• Stochastic кросовер на екстремумі
• Найкраще для швидких розворотів

📍 5-15 ХВИЛИН (короткострок):
• RSI 65-75 або 25-35 = помірний сигнал
• BB 70-85% або 15-30% = біля межі
• ADX > 25 = є тренд
• Збалансований варіант

📍 30-60 ХВИЛИН (середньострок):
• ADX > 30 = сильний тренд, потрібен час
• Декілька індикаторів співпадають
• MACD тільки починає розворот
• TradingView = BUY/SELL (не NEUTRAL)

📍 120-240 ХВИЛИН (2-4 години, довгострок):
• ADX > 35 = дуже сильний тренд
• Всі індикатори співпадають
• Для сильних трендових рухів
• TradingView = STRONG_BUY/STRONG_SELL
...
{"direction":"UP" або "DOWN" або null,"timeframe":1/3/5/10/15/30/60/120/180/240,"confidence":75-92,"analysis":"[ВВЕРХ/ВНИЗ на X хв - пояснення чому]"}`;
